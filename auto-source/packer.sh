...
function run_aws_packer() {
	local function_name=run_packer packer_directory ami_name_prefix ami_description parent_ami_prefix vpc_name \
  ...
  export vpc_id security_group_id subnet_id ssh_bastion_host ssh_bastion_private_key_file source_ami;
